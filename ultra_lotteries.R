...
username <- ''
direc <- paste('C:/Users/', username, '/Documents/Data/ultra_lotteries/Data/', sep = '')

# Reading in the data

races <- read.csv(paste(direc, 'data_race_count.csv', sep = ''))
place <- read.csv(paste(direc, 'data_mean_place.csv', sep = ''))
wins <- read.csv(paste(direc, 'data_wins.csv', sep = ''))
winpct <- read.csv(paste(direc, 'data_win_percentage.csv', sep = ''))
size <- read.csv(paste(direc, 'data_mean_race_size.csv', sep = ''))
alt <- read.csv(paste(direc, 'data_mean_race_altitude.csv', sep = ''))
travel <- read.csv(paste(direc, 'data_mean_travel_distance.csv', sep = ''))
f <- read.csv(paste(direc, 'data_mean_percent_female.csv', sep = ''))
...
stargazer(se.races.l1, se.races.l2, se.races.l3, se.races.l4, se.races.r1, se.races.r2, se.races.r3, se.races.r4, type = 'text', omit.stat = c('f', 'ser'), omit = c('State', 'Year'))
stargazer(se.place.l1, se.place.l2, se.place.l3, se.place.l4, se.place.r1, se.place.r2, se.place.r3, se.place.r4, type = 'text', omit.stat = c('f', 'ser'), omit = c('State', 'Year'))
stargazer(se.wins.l1, se.wins.l2, se.wins.l3, se.wins.l4, se.wins.r1, se.wins.r2, se.wins.r3, se.wins.r4, type = 'text', omit.stat = c('f', 'ser'), omit = c('State', 'Year'))
stargazer(se.winpct.l1, se.winpct.l2, se.winpct.l3, se.winpct.l4, se.winpct.r1, se.winpct.r2, se.winpct.r3, se.winpct.r4, type = 'text', omit.stat = c('f', 'ser'), omit = c('State', 'Year'))
stargazer(se.size.l1, se.size.l2, se.size.l3, se.size.l4, se.size.r1, se.size.r2, se.size.r3, se.size.r4, type = 'text', omit.stat = c('f', 'ser'), omit = c('State', 'Year'))
stargazer(se.alt.l1, se.alt.l2, se.alt.l3, se.alt.l4, se.alt.r1, se.alt.r2, se.alt.r3, se.alt.r4, type = 'text', omit.stat = c('f', 'ser'), omit = c('State', 'Year'))
stargazer(se.travel.l1, se.travel.l2, se.travel.l3, se.travel.l4, se.travel.r1, se.travel.r2, se.travel.r3, se.travel.r4, type = 'text', omit.stat = c('f', 'ser'), omit = c('State', 'Year'))
stargazer(se.f.l1, se.f.l2, se.f.l3, se.f.l4, se.f.r1, se.f.r2, se.f.r3, se.f.r4, type = 'text', omit.stat = c('f', 'ser'), omit = c('State', 'Year'))
stargazer(se.ff.l1, se.ff.l2, se.ff.l3, se.ff.l4, se.ff.r1, se.ff.r2, se.ff.r3, se.ff.r4, type = 'text', omit.stat = c('f', 'ser'), omit = c('State', 'Year'))
